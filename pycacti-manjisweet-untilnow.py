...
def login_pycacti_getimage(db, de, httpsrc, httppw):
	...
	request = urllib.request.Request(idxh + '/graph_image.php?action=zoom&local_graph_id=9172&rra_id=0&view_type=&graph_start=%s&graph_end=%s&graph_height=120&graph_width=600&title_font_size=10' % (int(db), int(de)), None ,headers)
	res = urlOpener.open(request).read()
	#print res
	return (res)
...
if __name__=='__main__':
	...
	#print res2
	file_name2 = './/BA-manjisweet//' + str("manji_chj") + '.png'
	print (file_name2)
